 ...
 */
defined('BASEPATH') or exit('No direct script access allowed');
defined('HUNGNG_WEBSITE') or define('HUNGNG_WEBSITE', 'https://nguyenanhung.com');
defined('HUNGNG_EMAIL') or define('HUNGNG_EMAIL', 'dev@nguyenanhung.com');
defined('POWERED_HUNGNG_WEBSITE') or define('POWERED_HUNGNG_WEBSITE', 'https://nguyenanhung.com');
defined('POWERED_HUNGNG_BLOG') or define('POWERED_HUNGNG_BLOG', 'https://blog.nguyenanhung.com');
